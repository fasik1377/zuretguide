                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            Text(
                                              'FKLM Ethiopia Tours is a reputable Tour, Travel and Car Rental service provider based in Addis Ababa, Ethiopia',
                                              style: TextStyle(fontSize: 12.0),
                                            ),
                                            Text(
                                              'Address: Equatorial Guinea Street, Hayahulet-Megenagna Road, BTRED BUILDING, 2nd floor, Room A, Addis Ababa',
                                              style: TextStyle(fontSize: 12.0),
                                            ),
                                            Row(
                                              children: <Widget>[
                                            ...
                                            Padding(
                                              padding: const EdgeInsets.only(
                                                  top: 20.0),
                                              child: Text('Tour and Travel Guide',
                                                  style: TextStyle(
                                                      fontWeight:
                                                          FontWeight.bold,
                                                      color: Colors.black,
